...
public class ModComponents {
    ...
    public static final DataComponentType<MagicPaperData> MAGIC_PAPER = register("magic_paper",
            DataComponentType.<MagicPaperData>builder().persistent(MagicPaperData.CODEC).packetCodec(MagicPaperData.PACKET_CODEC));

    public static final DataComponentType<MagicBookData> MAGIC_BOOK = register("magic_book",
            DataComponentType.<MagicBookData>builder().persistent(MagicBookData.CODEC).packetCodec(MagicBookData.PACKET_CODEC));
